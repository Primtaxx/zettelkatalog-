...
#engine = create_engine('mysql+pymysql://root:rootroot@localhost/catalog') #mysql
...
class CatalogRESTHistory(Resource):
    ...
    def patch(self, id):
        ...
        history = CatalogHistory(des_id=id, description=description, datum=datetime.now().strftime("%Y-%m-%d %H:%M:%S"))
